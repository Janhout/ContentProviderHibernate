package com.practicas.janhout.contentproviderhibernate.basedatos;
...
public class ProveedorInmueble extends ContentProvider {
    ...
    static String AUTORIDAD = "com.practicas.janhout.contentproviderhibernate.basedatos.proveedorinmueble";
